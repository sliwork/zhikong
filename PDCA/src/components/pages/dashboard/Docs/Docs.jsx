						...
						<div className="docs-content">
							...
							<h3>Installation</h3>
								<div className="subject-content">
									To use the Ani React Theme, you need to make sure you have <code>npm</code> globally installed. Now navigate to your app directory (<code>$ cd myReactApp/</code>) and run the following terminal commands :
									<ul>
										<li>
									...
									<div className="subject-content">
										...
										<ul className="features-list">
											<li>
												...
												<br />
												(with a single 'import' statement change e.g. to change from blue to red theme, replace this statement in app.jsx
												<ul>
													<li>
											...
											<li>
												Boostrap, React Bootstrap UI and third party plugins and elements including:
												<ul className="features-list-extended">
													<li>
														Dynamic Charts
													</li>
							...
							<div id="widgets">
										...
										<Well>
											...
											<div className="widget-docs-code">
												<pre>
													...
													&nbsp;&nbsp;&nbsp;&nbsp;header=&#123;&lt;span&gt;Primary Panel&lt;/span&gt;&#125;<br />
													&gt;<br />
									      ...
									      <MenuItem eventKey="4">Separated link</MenuItem>
											...
											<div className="widget-docs-code">
												<pre>
													...
													&nbsp;&nbsp;&nbsp;&nbsp;title=&#123;&lt;span&gt;Button dropdown&lt;/span&gt;&#125;<br />
													&gt;<br />
													&nbsp;&nbsp;&nbsp;&nbsp;&lt;MenuItem eventKey="1"&gt;Action&lt;/MenuItem&gt;<br />
											    &nbsp;&nbsp;&nbsp;&nbsp;&lt;MenuItem eventKey="2"&gt;Another action&lt;/MenuItem&gt;<br />
											    &nbsp;&nbsp;&nbsp;&nbsp;&lt;MenuItem eventKey="3"&gt;Something else here&lt;/MenuItem&gt;<br />
											    &nbsp;&nbsp;&nbsp;&nbsp;&lt;MenuItem divider /&gt;<br />
											    &nbsp;&nbsp;&nbsp;&nbsp;&lt;MenuItem eventKey="4"&gt;Separated link&lt;/MenuItem&gt;<br />
													&lt;/DropdownButton&gt;<br />
												</pre>
											</div>
											...
											<Well>
												...
												<div className="widget-docs-code">
													<pre>
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;Button className="close"&gt;&lt;span aria-hidden="true"&gt;×&lt;/span&gt;&lt;/Button&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;My alert message.<br />
														&lt;/Alert&gt;
													</pre>
												</div>
			                  ...
			                  <div className="widget-docs-code">
													<pre>
														&lt;OverlayTrigger placement="left" overlay=&lt;Tooltip&gt;On the Left!&lt;/Tooltip&gt; &gt;<br />
				                    &nbsp;&nbsp;&nbsp;&nbsp;&lt;Button&gt;Left Tooltip&lt;/Button&gt;<br />
				                  	&lt;/OverlayTrigger&gt;
													</pre>
												</div>
												<OverlayTrigger trigger="click" placement="left" overlay={<Popover>To the Left!</Popover>}>
			                    <Button>Left Popover</Button>
			                  </OverlayTrigger>
			                  <div className="widget-docs-code">
													<pre>
														&lt;OverlayTrigger trigger="click" placement="left" overlay=&#123;&lt;Popover&gt;To the Left!&lt;/Popover&gt;&#125;&gt;<br />
				                    &nbsp;&nbsp;&nbsp;&nbsp;&lt;Button&gt;Left Popover&lt;/Button&gt;<br />
				                  	&lt;/OverlayTrigger&gt;
				                  </pre>
				                </div>
				                <code>For popovers and tooltips in different replace "left" with "top/right/bottom"</code>
									      ...
									      <div className="widgets-docs-code">
											...
											<Well>
									      	...
									      	<pre>
									      		&lt;Accordion&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;Panel header="Click here for Collapse" eventKey="1"&gt;<br />
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;/Panel&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;Panel header="Click here for Collapse" eventKey="2"&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ad vegan excepteur butcher vice lomo.<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;/Panel&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;Panel header="Click here for Collapse" eventKey="3"&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ad vegan excepteur butcher vice lomo.<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;/Panel&gt;<br />
														&lt;/Accordion&gt;
											...
											<Well>
												<h4>Icons</h4>
												<i className="fa fa-glass"></i> &nbsp;&nbsp; <i className="fa fa-bar-chart-o"></i>
												<div className="widget-docs-code">
													<pre>
											...
											<Well>
												...
												<code>The table classes can be changed using bordered/hover/condensed props. </code>
											</Well>
											...
											<Well>
												...
												<div className="widget-docs-code">
													<pre>
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;div className="onoffswitch"&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;input type="checkbox" name="onoffswitch" className="onoffswitch-checkbox" id="switch3" <br />
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;onClick=&#123;() => this.setState(&#123;switchState : !this.state.switchState&#125;)&#125; /&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;label className="onoffswitch-label" for="switch3"&gt;<br />
											...
											<Well>
												...
												<div className="widget-docs-code">
													<pre>
														&lt;form&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;Input type="email" label="Email address" placeholder="Enter email" className="underline" /&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;Input type="password" label="Password" placeholder="Password" className="underline" /&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;Input type="checkbox" label="Remember me" /&gt;<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&lt;ButtonInput value="Submit" /&gt;<br />
														&lt;/form&gt;
													</pre>
												</div>
											</Well>
								...
								<div className="subject-content">
									<Well>
										...
										<div className="widget-docs-code">
										    ...
										    &nbsp;&nbsp;&nbsp;&nbsp;$(this.refs.calendar).fullCalendar(&#123;&#125;);<br />
										  	&#125;
											</pre>
										</div>
									</Well>
									...
									<Well>
										...
										<div className="widget-docs-code">
											...
											JavaScript
											<pre>
												var data1 = [ &#123; value: 300,	color:"#F7464A", highlight: "#FF5A5E", label: "Red" &#125;,<br />
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123; value: 50, color: "#46BFBD", highlight: "#5AD3D1", label: "Green" &#125;, <br />
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123;	value: 100, color: "#FDB45C", highlight: "#FFC870", label: "Yellow" &#125; ];<br />
												<br />
									...
									<Well>
										...
										<div className="widget-docs-code">
											<pre>
												&lt;C3Chart data=&#123;data&#125 type=&#123;"pie"&#125 options=&#123;options&#125 value=&#123;2&#125 /&gt;
											</pre>
											JavaScript
											<pre>
												let data = [&#123; <br />
												&nbsp;&nbsp;&nbsp;&nbsp;key: "data-1",<br />
												&nbsp;&nbsp;&nbsp;&nbsp;values: [ &#123;label: "0", value: 30&#125;,<br />
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123;label: "1", value: 30&#125;,<br />
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123;label: "2", value: 40&#125;,<br />
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123;label: "3", value: 40&#125;,<br />
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123;label: "4", value: 20&#125;,<br />
												...
												<br />
												let options = &#123;<br />
												&nbsp;&nbsp;&nbsp;&nbsp;padding: &#123; top: 20, bottom: 20, left: 40, right: 10 &#125;,<br />
												&nbsp;&nbsp;&nbsp;&nbsp;size: &#123; width: 450, height: 300 &#125;,<br />
												&nbsp;&nbsp;&nbsp;&nbsp;subchart: false,<br />
												&nbsp;&nbsp;&nbsp;&nbsp;zoom: true,<br />
									...
									<Well>
										...
										<growl-notifications>
											<growl-notification class="growl-warning" style={ {display: this.state.showGrowl?'':'none'} }>
												Warning Notification
											</growl-notification>
										</growl-notifications>
										<div className="widget-docs-code">
											<pre>
												&lt;Button bsStyle="warning" onClick=&#123;this.toggleGrowl&#125; name="Warning">Warning Growl&lt;/Button&gt; <br />
												&lt;growl-notifications&gt;<br />
												&nbsp;&nbsp;&nbsp;&nbsp;&lt;growl-notification class="growl-warning" style=&#123; &#123;display: this.state.showGrowl?'':'none'&#125; &#125;&gt;<br />
											...
											<pre>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;var that = this;<br />
												&nbsp;&nbsp;&nbsp;&nbsp;this.setState(&#123;showGrowl: !this.state.showGrowl&#125;);<br />
												&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(function()&#123;<br />
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;that.setState(&#123;showGrowl: false&#125;);<br />
												&nbsp;&nbsp;&nbsp;&nbsp;&#125;,5000)<br />
												&#125; 
											</pre>
										</div>
